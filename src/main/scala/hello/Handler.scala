...
class Handler extends RequestHandler[Request, Response] {
  ...
  def handleRequest(input: Request, context: Context): Response = {
    ...
    Response("1 Go Serverless v1.0! Your function executed successfully!", input)
  }
}
...
class ApiGatewayHandler extends RequestHandler[Request, ApiGatewayResponse] {
  ...
  def handleRequest(input: Request, context: Context): ApiGatewayResponse = {
    ...
    ApiGatewayResponse(200, "2 Go Serverless v1.0! Your function executed successfully!",
      headers.asJava,
      true)
  }
}
